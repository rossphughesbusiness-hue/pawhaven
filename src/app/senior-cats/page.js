...
export const metadata = {
  ...
  description: 'Shop expert-curated products for senior cats aged 7+. Supportive beds, gentle enrichment, grooming tools for arthritic cats, and calming aids for anxious older felines.',
        ...
        <section className="bg-gradient-to-br from-rose-700 via-pink-700 to-rose-600 text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-sm">
              {['🔬 Expert-reviewed', '🐾 Senior-tested', '🦴 Joint-friendly', '📦 Free shipping $50+'].map(b => (
