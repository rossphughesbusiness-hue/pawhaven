export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Pick 2–4 products and save up to 20%. Free shipping on orders over $50.',
    url: 'https://pawhavenpets.org/build-a-bundle',
    type: 'website',
  },
};

export default function BuildABundleLayout({ children }) {
  return children;
}
